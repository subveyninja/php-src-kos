...
/* $Id: b7393f97108b1f663655c8b48ce937e9c41e69f7 $ */
...
function main(): void
{
        ...
        while ($repeat) {
            ...
            switch ($switch) {
                ...
                case '--no-progress':
                    ...
                    break;
                case '--version':
                    echo '$Id: b7393f97108b1f663655c8b48ce937e9c41e69f7 $' . "\n";
                    exit(1);
    ...
    // KOS: for searching execution bin
...
";
	...
	if ($test->hasSection('ENV')) {
		return skip_test($tested, $tested_file, $shortname, 'KOS.ENV test requiring ENV section');
    }
